...
if (Object.defineProperty(exports, "__esModule", {
    ...
    let t;
    t = "object" == typeof Reflect && "function" == typeof Reflect.ownKeys ? Reflect.ownKeys: "function" == typeof Object.getOwnPropertySymbols ?
    function(t) {
...
class Page$1 {
    ...
    _getQuery(t) {
        return Object.keys(t).filter(t = >"wxShoppingListScene " !== t).map(e = >`$ {
            e
        } = $ {
            t[e]
        }`).join(" & ")
...
function getHandle(t, e, n) {
    ...
    a ? Object.keys(a.$slots).forEach(function(t) {
        var s = a.$slots[t]; (Array.isArray(s) ? s: [s]).forEach(function(t) {
    ...
    var u = r.attrs,
    h = r.on;
    return u && h && u.eventid === e && n.forEach(function(t) {
        var e = h[t];
        "
...
function isValidListener(t) {
    return "
        function " == typeof t || t instanceof RegExp || !(!t || "object " != typeof t) && isValidListener(t.listener)
}
proto.getListeners = function(t) {
    var e, n, i = this._getEvents();
    if (t instanceof RegExp) for (n in e = {},
    i) i.hasOwnProperty(n) && t.test(n) && (e[n] = i[n]);
    else e = i[t] || (i[t] = []);
    return e
},
...
proto.addListener = function(t, e) {
    if (!isValidListener(e)) throw new TypeError("listener must be a
        function ");
...
proto.addOnceListener = function(t, e) {
...
proto.addListeners = function(t, e) {
...
proto.manipulateListeners = function(t, e, n) {
    ...
    else for (i in e) e.hasOwnProperty(i) && (s = e[i]) && ("
        function " == typeof s ? r.call(this, i, s) : o.call(this, i, s));
    return this
},
...
proto.emitEvent = function(t, e) {
    var n, i, s, r, o = this.getListenersAsObject(t);
    for (r in o) if (o.hasOwnProperty(r)) for (n = o[r].slice(0), s = 0; n.length > s; s++) ! 0 === (i = n[s]).once && this.removeListener(t, i.listener),
    i.listener.apply(this, e || []) === this._getOnceReturnValue() && this.removeListener(t, i.listener);
    return this
},
proto.trigger = alias("emitEvent "),
proto.emit = function(t) {
...
class Observer {
    ...
    get sessionId() {
        return null === this._sessionId && (this._sessionId = Utils.guid()),
        this._sessionId
    }
    resetSessionId() {
        this._sessionId = null
    ...
    pageListener(t, e, n) {
        if (this.growingio.debug && console.log("Page.", t.route, "#", e, Date.now()), "onShow " === e) this.isPauseSession ? this.isPauseSession = !1 : (this.currentPage.touch(t), this.sendPage(t));
        ...
        else if ("onUnload " === e) this.currentPage.pvar[`$ {
            ...
            var i = null,
            s = null;
            2 > n.length ? 1 === n.length && (n[0].from ? i = n[0] : n[0].title && (s = n[0])) : (i = n[0], s = n[1]),
            this.pauseSession(),
            this.sendPageShare(t, i, s)
    ...
    setPage(t) {
        ...
        this.currentPage.touchRelatedPvarData(e),
        this._sendEvent(e)
    }
    setEvar(t) {
        this._sendEvent({
    ...
    sendVisitEvent(t, e = "wgs84 ") {
        ...
        if (this.growingio.appVer && (i.cv = this.growingio.appVer + ""), t.length > 0) {
            var s = t[0];
            i.p = s.path,
            Utils.isEmpty(s.query) || (i.q = this.currentPage._getQuery(s.query)),
            i.ch = `scn: $ {
                this.scene
            }`,
            s.referrerInfo && s.referrerInfo.appId && (i.rf = s.referrerInfo.appId)
        }
        this.weixin.getNetworkType().then(t = >{
            t && (i.nt = t.networkType, this.growingio.getLocation ? this.weixin.requestLocation(e).then(() = >{
    ...
    sendPage(t) {
        ...
        this.lastPageEvent ? (e.rp = this.lastPageEvent.p, this.useLastPageTime && (e.tm = this.lastPageEvent.tm, this.useLastPageTime = !1)) : e.rp = this.scene ? `scn: $ {
            this.scene
        }`: null,
        t.data && t.data.pvar && (e.
        var = t.data.pvar);
        var n = this.weixin.getPageTitle(t);
        n && n.length > 0 && (e.tl = n),
        this._sendEvent(e),
        this.lastPageEvent = e;
        const i = this.currentPage.pvar[`$ {
            this.currentPage.path
        } ? $ {
            this.currentPage.query
        }`];
        i && i.length > 0 && i.map(t = >{
            t.ptm = this.currentPage.time,
            this._sendEvent(t)
        })
    }
    sendPageShare(t, e, n) {
    ...
    sendClick(t, e) {
        ...
        i.dataset.title ? s.v = i.dataset.title: i.dataset.src && (s.h = i.dataset.src),
        void 0 !== i.dataset.index && (s.idx = /^[\d]+$/.test(i.dataset.index) ? parseInt(i.dataset.index) : -1),
        n.e = [s],
        this._sendEvent(n)
    }
    sendSubmit(t, e) {
    ...
    _sendEvent(t) {
        if (t.u = this.weixin.uid, t.s = this.sessionId, t.tm = t.tm || Date.now(), t.d = this.growingio.appId, t.b = "MinP ", null !== this.cs1 && (t.cs1 = this.cs1), t.
        var) {
            let e = t.
            var;
            Object.keys(e).forEach(n = >{
                "string " != typeof e[n] && (t.
                var [n] = JSON.stringify(e[n]))
            })
        }
...
class Weixin {
    ...
    get esid() {
        return this._esid || (this._esid = 1),
        this._esid
    }
    set uid(t) {
        this._uid = t,
    ...
    get uid() {
        return this._uid || (this.uid = Utils.guid()),
        this._uid
    }
    syncStorage() {
        ...
        try {
            if (t.data.title && t.data.title.length > 0 && (e = Array.isArray(t.data.title) ? t.data.title.join("") : t.data.title), 0 === e.length && __wxConfig) {
                if (__wxConfig.tabBar) {
                    var n = __wxConfig.tabBar.list.find(e =>e.pathPath == t.route || e.pagePath == `$ {
                        t.route
                    }.html`);
                    n && n.text && (e = n.text)
                }
                if (0 == e.length) {
                    var i = __wxConfig.page[t.route] || __wxConfig.page[`$ {
                        t.route
                    }.html`];
...
VdsInstrumentAgent = {
    ...
    initInstrument: function(t, e) {
        ...
        e ? (global.GioPage = VdsInstrumentAgent.GrowingPage, global.GioApp = VdsInstrumentAgent.GrowingApp, global.GioComponent = VdsInstrumentAgent.GrowingComponent, global.GioBehavior = VdsInstrumentAgent.GrowingBehavior, global.trackApp = function() {
            const t = arguments[0];
            return t._growing_app_ = !0,
            VdsInstrumentAgent.instrument(t)
        },
...
class GrowingIO {
    ...
    init(t, e, n = {}) {
        this.start || (this.start = !0, this.projectId = t, "string " == typeof e ? this.appId = e: (n = e, this.appId = Utils.getAppId()), this.appVer = n.version, this.debug = n.debug || !1, this.forceLogin = n.forceLogin || !1, this.followShare = n.followShare || !1, this.usePlugin = n.usePlugin || !1, this.getLocation = ("object " == typeof n.getLocation ? n.getLocation.autoGet: n.getLocation) || !1, this.getLocationType = "object " == typeof n.getLocation && n.getLocation.type || "wgs84 ", this.keepAlive = +n.keepAlive || duration5min, this.vue = !!n.vue, this.taro = !!n.taro, this.dataCollect = !(n.stopTrack && !n.dataCollect), this.weixin = new Weixin(this), this.esid = this.weixin.esid, this.host = "https: //wxapi.growingio.com", n.host && n.host.indexOf("http") >= 0 && (this.host = "https://" + n.host.slice(n.host.indexOf("://") + 3)), this.uploader = new Uploader(this), this.observer = new Observer(this), this.start = !0, n.vue && (this.vueRootVMs = {},
        this._proxyVue(n.vue)), n.taro && (this.taroRootVMs = {},
        this._proxyTaro(n.taro)), n.cml && this._proxyCml(n.cml), this._start())
    }
    setVue(t) {
    ...
    login(t) {
        if (this.forceLogin) for (var e of(this.weixin.uid = t, this.forceLogin = !1, this.uploadingMessages)) e.u = t,
        this._upload(e)
    }
    upload(t) {
    ...
    _proxyTaro(t) {
        ...
        t.createComponent = function(t, i) {
            ...
            for (; s && s.prototype;) {
                ...
                for (let i = 0; n.length > i; i++) if (n[i].startsWith("func__")) {
                    const r = s.name,
                    o = n[i].slice(6);
            ...
            const r = n(t, i);
            return i && VdsInstrumentAgent.instrumentTaroPageComponent(r),
            r
        }
    }
    _proxyCml(t) {
        ...
        t.createApp = function(t) {
            const n = e(t);
            return VdsInstrumentAgent.GrowingApp(n.options),
            n
        }
    }
    _proxyVue(t) {
...
if (console.log("init growingio..."), Utils.compareVersion(Utils.sdkVer, "1.9.0") >= 0 && !growingio.start) {
    const t = require("./gioConfig").
default;
    growingio.init(t.projectId, t.appId ? t.appId: Utils.getAppId(), t)
}
